...
| 观看者映射问题 | 一个陌生读者点进这个问题，实际上在拿它确认自己的什么现实处境？ |
| Personal Stakes | 读者正在确认什么、害怕失去什么、需要做什么判断、看完后能重新解释自己哪段现实？ |

选题优先级判断：

- 不只判断冲突大不大，也要判断读者能不能拿答案反观自己。
- 若题目只有公共围观、价值站队或情绪确认，标记为 Traffic Winner 候选，但不自动作为 Value Winner 优先题。
