...
| 05.5 规律验证库 | 知乎规律验证库 | `data/Milestone_Observations.md`; `production_variable_library.md` | 验证次数、成功率、证据强度、母题、是否允许升级协议 | 职责与当前 Observation / Parameter 生命周期高度相关 | 高 | PENDING CLASSIFICATION | `data/Milestone_Observations.md`; `production_variable_library.md` | Not Started | 这是下轮优先级最高的直属数据库之一 |
...
| L2 正文变量矩阵 | L2｜正文变量矩阵 | `production_variable_library.md`; `l2_variable_records.md`; `l2_variable_validation.md` | 正文变量、验证材料、变量矩阵 | Git 已有 L2 变量记录和验证文件 | 中 | MERGE / ARCHIVE / SKIP | `l2_variable_records.md`; `l2_variable_validation.md` | Not Started | 需按变量 ID / 变量名做 Schema + row diff |
...
- 优先级高的下一批是：05.5 规律验证库、L2 正文变量矩阵、平台爆款样本库、06 生产卡库、07 正文 QA 库。
...
7. 所有 Notion 资产清单项达到 `Covered / Checked / DROP / ARCHIVE_READY / MIGRATION_READY` 之一后，才进入实际迁移批处理。
